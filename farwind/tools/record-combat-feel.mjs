...
const dir = "docs/combat-feel/evidence";
...
await writeFile(`${dir}/side-audio.webm`, Buffer.from(audio.base64, "base64"));
await writeFile(`${dir}/side-audio-offset.txt`, String(audio.offset));
const video = page.video();
await page.close();
await video.saveAs(`${dir}/side-sample.webm`);
await browser.close();
