...
- WASD／方向键：移动；按住空格键：奔跑。
- E：与最近可达目标交互；J／画布左键：挥剑；L：风步。
...
向北找守风人接任务；在药师小院采药草、南侧果园采浆果、西侧木工区收集木材，村口南侧拾取溪石。沿东侧石路进入森林，在行囊用药草 ×2、浆果 ×1 制作恢复药剂。击退叶灵取得风之结晶，沿东北道路抵达遗迹。阅读古碑，依次回应西侧晨风、北侧林风、东侧暮风；消耗木材 ×2、石材 ×2、结晶 ×1 修复路标。南侧归乡风径开启后返回村庄交付。
...
世界扩为 4200×2200，新增西侧生活巷、南侧果园、药师小院、临水草坡、东北练习场与东村口，保留广场出生点和原训练木桩。按 M 查看七区说明与三条推荐路线（按道路长度估算步行约 12、27、8 秒）。药师可用药草 ×2、浆果 ×1 兑换恢复药剂；果园宝箱与采集进度沿用存档，木桥可走、池水不可穿越。

森林和遗迹向东平移 600 像素，旧存档自动迁移角色和待领取掉落坐标。开发服务中打开 `/docs/map-expansion/index.html` 查看实际截图；实现边界与验证结果见 [地图扩展记录](docs/map-expansion/REPORT.md)。
